...
#define     APP_VERSION_NAME        "HFWC"    //-> should be same as the main application
#define     APP_TAGINFO             "Lines/Words/Characters Counter"
#define     APP_COPYRIGHT           "Harris Georgiou (c) 2003"

#define     APP_VERSION_MAJOR       1       //= development phase (completed)
#define     APP_VERSION_MINOR       1       //= functionality level (completed)
#define     APP_VERSION_RELEASE     2003    //= corrections & enhancements or release year (yyyy)
#define     APP_VERSION_BUILD       0723     //= build number or release date (mmdd)
