...
#define     APP_VERSION_NAME        "HFFREQW"    //-> should be same as the main application
#define     APP_TAGINFO             "Word frequency analyzer"
...
#define     APP_VERSION_BUILD       0115     //= build number or release date (mmdd)
