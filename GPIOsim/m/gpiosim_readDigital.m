function value = gpiosim_readDigital( num )
%gpiosim_readAnalog - Read the digital value from an existing a GPIOsim I/O device
...
[~,value,~] = gpiosim_read(num);    % Note: no value checks, avoid delays
